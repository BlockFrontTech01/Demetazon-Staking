...
const SolanaStakingWithdrawalDapp = () => {
    ...
    <>
      <div className="relative bg-midnightblue w-full h-[1231px] overflow-hidden flex flex-row items-start justify-start p-2.5 box-border gap-[10px] text-center text-2xs text-white font-inter">
        ...
        <div className="my-0 mx-[!important] absolute top-[0px] left-[17px] w-[1636px] h-[126px] flex flex-row items-center justify-start gap-[1230px] z-[1] lg:gap-[900px] md:gap-[190px]">
          ...
          />
          <button
            className="cursor-pointer [border:none] p-0 bg-[transparent] relative rounded-xl [background:linear-gradient(180deg,_#0df6e8,_#000)] shadow-[0px_0px_100px_#0df6e8] w-[149px] h-7 overflow-hidden shrink-0 hover:animate-[1s_linear_0s_infinite_normal_none_jello-horizontal] hover:opacity-[1]"
        ...
        <div className="my-0 mx-[!important] absolute top-[210px] left-[47px] flex flex-row items-start justify-start gap-[500px] z-[2] text-mid font-inika lg:gap-[310px] md:w-[200px] md:flex-col md:gap-[0px] md:items-center md:justify-start md:pl-[130px] md:pr-0 md:box-border md:max-w-[200px]">
          ...
          <div className="relative w-[380px] h-[812px]">
            ...
            <b className="absolute top-[535px] left-[264px]">1stSOL = 1SOL</b>
            <b className="absolute top-[485px] left-[291px]">0.00 stSOL</b>
            <b className="absolute top-[435px] left-[325px]">$13.00</b>
            <b className="absolute top-[389px] left-[336px]">Free</b>
            <b className="absolute top-[335px] left-[325px]">0 SOL</b>
            <button
              className="cursor-pointer [border:none] p-0 bg-[transparent] absolute top-[603px] left-[115px] rounded-xl [background:linear-gradient(180deg,_#0df6e8,_#000)] shadow-[0px_0px_100px_#0df6e8] w-[149px] h-7 overflow-hidden hover:animate-[1s_linear_0s_1_normal_none_jello-horizontal] hover:opacity-[1]"
            ...
            <div className="absolute top-[197px] left-[0px] rounded-11xl bg-midnightblue shadow-[0px_0px_10px_#0df6e8] w-[380px] h-[81px] overflow-hidden text-sm">
              ...
              />
              <input
                className="[border:none] font-inika text-sm bg-[transparent] absolute top-[31px] left-[66px] font-bold text-white text-left"
                placeholder=" Amount"
                type="text"
              />
            ...
            <div className="absolute top-[64px] left-[3px] text-mini inline-block w-[377px] h-5">
              Request stSOL withdrawals and claim it
            </div>
          </div>
        </div>
      </div>
...
export default SolanaStakingWithdrawalDapp;
