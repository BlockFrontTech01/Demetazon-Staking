...
const SolanaStakingDapp = () => {
  ...
  const onFrameContainer4Click = useCallback(() => {
    router.push("/solana-staking-withdrawal-dapp");
  }, [router]);
  ...
  return (
    <>
      <div className="relative bg-midnightblue w-full h-[1231px] overflow-hidden flex flex-row items-start justify-start p-2.5 box-border gap-[10px] text-center text-2xs text-white font-inter">
        ...
        <div className="my-0 mx-[!important] absolute top-[210px] left-[47px] flex flex-row items-start justify-start gap-[500px] z-[1] text-mid font-inika lg:gap-[310px] md:w-[200px] md:flex-col md:gap-[0px] md:items-center md:justify-start md:pl-[130px] md:pr-0 md:box-border md:max-w-[200px]">
          ...
          <div className="relative w-[380px] h-[812px]">
            ...
            <b className="absolute top-[435px] left-[337px]">$1,58</b>
            <b className="absolute top-[385px] left-[260px]">1 SOL = 1stSOL</b>
            <b className="absolute top-[335px] left-[313px]">0 stSOL</b>
            <div
              className="absolute top-[564px] left-[112px] rounded-xl [background:linear-gradient(180deg,_#0df6e8,_#000)] shadow-[0px_0px_100px_#0df6e8] w-[149px] h-7 overflow-hidden cursor-pointer text-base font-inconsolata"
              onClick={openConnectwalletDropdown}
            >
              <b className="absolute top-[6px] left-[18px]">Connect Wallet</b>
            </div>
            <div className="absolute top-[197px] left-[0px] rounded-11xl bg-midnightblue shadow-[0px_0px_10px_#0df6e8] w-[380px] h-[81px] overflow-hidden text-sm">
              ...
              />
              <input
                className="[border:none] font-inika text-sm bg-[transparent] absolute top-[31px] left-[79px] font-bold text-white text-left"
            ...
            <div
              className="absolute top-[757px] left-[51px] rounded-11xl bg-midnightblue shadow-[0px_0px_5px_#01fff0_inset] w-[280px] h-[55px] overflow-hidden cursor-pointer text-xl font-inknut-antiqua"
              onClick={onFrameContainer4Click}
            >
              <b className="absolute top-[-4px] left-[64px]">Withdrawals</b>
            </div>
            <div className="absolute top-[64px] left-[3px] text-mini inline-block w-[377px] h-5">
              Stake SOL and recieve stSOL while staking
            </div>
          </div>
        </div>
        <div className="my-0 mx-[!important] absolute top-[0px] left-[16px] w-[1636px] h-[126px] flex flex-row items-center justify-start gap-[1230px] z-[2] lg:gap-[900px] md:gap-[190px]">
          <img
          ...
          />
          <button
            className="cursor-pointer [border:none] p-0 bg-[transparent] relative rounded-xl [background:linear-gradient(180deg,_#0df6e8,_#000)] shadow-[0px_0px_100px_#0df6e8] w-[149px] h-7 overflow-hidden shrink-0 [&.animate]:animate-[1s_linear_0s_1_normal_forwards_jello-horizontal] opacity-[1]"
...
export default SolanaStakingDapp;
